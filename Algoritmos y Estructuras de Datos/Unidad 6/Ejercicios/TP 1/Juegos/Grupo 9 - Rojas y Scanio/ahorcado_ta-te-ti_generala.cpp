...
string elegir_palabra(const string palabras_lista[100]) {
    srand(time(nullptr));
    return palabras_lista [rand() % 100];
...
void ahorcado(){
    string palabras_lista[100] = {"computacion","expo","toriggia", "lenguaje", "programacion", "computadora", "calippo","windows","linux","rojas","scanio","estudio","politecnico","lealtad"};
